...
class PageStyle: NSObject {
    ...
    var titleFont: UIFont = UIFont(name: "PingFangSC-Semibold", size: 17)!
    var titleSelectedFont: UIFont = UIFont(name: "PingFangSC-Semibold", size: 17)!
    
    /// 标题颜色必须使用RGB值创建（目的：动态更改标题颜色通过动态改变RGB值实现）
    var titleTextColor: UIColor = UIColor(red: 155/255.0, green: 48/255.0, blue: 255/255.0, alpha: 1.0)
    /// 标题颜色必须使用RGB值创建（目的：动态更改标题颜色通过动态改变RGB值实现）
    var titleSelectedTextColor: UIColor = UIColor(red: 0/255.0, green: 0/255.0, blue: 0/255.0, alpha: 1.0)
